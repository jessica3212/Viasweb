<footer class="px-4 divide-y bg-gray-100 text-gray-800">
		...
		<div class="lg:w-1/3">
			<a href="#" class="flex justify-center space-x-3 lg:justify-start">
				<div class="flex items-center justify-center w-12 h-12 rounded-full dark:bg-violet-400">
					<img src="{{ asset('img/logo3-cas.png') }}">
				</div>
				<span class="self-center text-2xl font-semibold">INVENTARIO VIAL</span>
			</a>
		</div>
	...
	<div class="py-6 text-sm text-center dark:text-coolGray-400">© 2021 Vias App. Reservados todos los derechos.</div>
</footer>