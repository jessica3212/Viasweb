<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <main
                class="flex flex-col lg:flex-row bg-gray-600 backdrop-filter backdrop-blur-md rounded-xl overflow-hidden shadow-lg m-2 lg:m-2">
                <div class="flex-1 p-4 lg:p-6">
                    ...
                    <div class="grid grid-rows-4 grid-cols-1 gap-4 md:grid-rows-2 md:grid-cols-4">
                        ...
                        <div
                            ...
                            <div class="text-white font-normal">{{ $sign->estado_tablero }}</div>
                        </div>
                        ...
                        <div
                            ...
                            <div class="text-white font-normal">{{ $sign->estado_paral }}</div>
                        </div>
                        <div
                            class="rounded-md bg-white backdrop-filter backdrop-blur-lg bg-opacity-20 p-4 flex flex-col relative undefined">
                            <div class="text-white absolute right-2">
