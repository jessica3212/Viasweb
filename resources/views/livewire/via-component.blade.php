<div>
    <section class="bg-gradient-to-r from-white to-gray-200 shadow">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center text-sm">
                                        <a class="pl-2 hover:text-red-600 cursor-pointer text-md"
                                            wire:click="$emit('deleteVia', '{{ $via->id }}')"><i class="fas fa-trash-alt"></i></a>
                                    </td>
        ...
        Livewire.on('deleteVia', viaId => {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Livewire.emitTo('vias-via-component', 'delete', viaId)
                    Swal.fire(
                        '¡Eliminado!',
