<nav x-data="{ open: false }" class="bg-gradient-to-r from-green-600 to-gray-100 border-b border-gray-100">
                        ...
                        <x-slot name="trigger">
                            ...
                            <button
                                ...
                                <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                    ...
                                    class="h-10 w-10 rounded-full object-cover text-gray-100">
                                    <path
