<x-app-layout>
  ...
  <div class="m-3 overflow-hidden shadow-xl sm:rounded-lg">
    <section class="text-gray-600 body-font relative ">
        <div class="absolute inset-0 bg-gray-300">
          <iframe width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0" title="map" scrolling="no" src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=es&amp;q=+(Gobernaci%C3%B3n%20de%20Casanare)&amp;t=&amp;z=17&amp;ie=UTF8&amp;iwloc=B&amp;output=embed" style="filter: grayscale(0) contrast(0.8) opacity(1);"></iframe>

          
        </div>
        <div class="container px-5 py-24 mx-auto flex">
          <div class="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10 shadow-xl">
            <h2 class="text-gray-900 text-lg mb-1 font-medium title-font">Buzón de sugerencias</h2>
            <p class="leading-relaxed mb-5 text-gray-600">Aquí puedes realizar quejas peticiones y reclamos.</p>
            ...
            <button class="text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">Envíar</button>
            <p class="text-xs text-gray-500 mt-3">Recibirás una pronta respuesta según el asunto de tu mensaje.</p>
          </div>
        </div>
      </section>
    </div>
